  ...
  >
    ...
    <div className="flex items-center gap-4">
      ...
      <div>
        ...
        <p className="text-sm text-gray-400">PS4</p>
        <button
      ...
      <div className="text-right min-w-[100px]">
        ...
        <div className="w-full lg:w-1/3 bg-[#1e1e1e] p-6 rounded-lg h-fit">
          ...
          <div className="py-4">
            ...
            />
            <button className="mt-2 bg-lime-400 hover:bg-lime-500 w-full py-2 rounded text-black">
              Apply
            </button>
          </div>
          ...
          <button className="w-full bg-purple-600 hover:bg-purple-700 py-3 rounded text-white font-semibold mt-4">
            Checkout
          </button>
        </div>
      </div>
